    ...
    <div class="slimscroll-menu" id="remove-scroll">
       ...
       <div id="sidebar-menu">
          ...
          <ul class="metismenu" id="side-menu">
             ...
             <li>
                <a href="{{route('profdashbord')}}" class="waves-effect">
             ...
             <li>
                <a href="javascript:void(0);" class="waves-effect"><span> My notes <span class="float-right menu-arrow"><i class="mdi mdi-chevron-right"></i></span> </span> </a>
                <ul class="submenu">
                   <li><a href="ui-alerts.html">List</a></li>
             ...
             <li>
                <a href="javascript:void(0);" class="waves-effect"><span> Courses<span class="float-right menu-arrow"><i class="mdi mdi-chevron-right"></i></span> </span> </a>
                
             </li>
             <li>
                <a href="javascript:void(0);" class="waves-effect"><span> Groupes<span class="float-right menu-arrow"><i class="mdi mdi-chevron-right"></i></span> </span> </a>
                <!--<ul class="submenu">
             ...
             <li>
               <a href="javascript:void(0);" class="waves-effect"><span> Timetable<span class="float-right menu-arrow"></span> </span> </a>
             </li>

             <!--<li>
                <a href="javascript:void(0);" class="waves-effect"><span> Add Prof to class<span class="float-right menu-arrow"><i class="mdi mdi-chevron-right"></i></span> </span> </a>
                <ul class="submenu">
                   <li><a href="ui-alerts.html">Add</a></li>
                   <li><a href="ui-buttons.html">List</a></li>
                </ul>
             ...
             <li>
                <a href="javascript:void(0);" class="waves-effect"><span> Classes<span class="float-right menu-arrow"><i class="mdi mdi-chevron-right"></i></span> </span> </a>
             </li>
               <li>
